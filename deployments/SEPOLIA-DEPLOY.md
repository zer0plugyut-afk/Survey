...
| RISC0 router (official) | `0x925d8331ddc0a1F0d96E68CF073DFE1d92b69187` |
| PoseidonT3 (linked) | `0x3333333C0A88F9BE4fd23ed0536F9B6c427e3B93` |
| BFV | `INSECURE_THRESHOLD_512` / `paramSet: 0` |

- Env: `deployments/survey-program.env`
- Submit text: `docs/SUBMIT-PROGRAM.md`
